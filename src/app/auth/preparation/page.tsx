...
const PREPARATION_IMAGES = [
  "/images/preparation/level1.png",
  "/images/preparation/level2.png",
  "/images/preparation/level3.png",
  "/images/preparation/level4.png",
  "/images/preparation/level5.png",
]
    ...
    <div className="flex flex-col items-center">
      <div className={`${wide} mx-auto mt-8`}>
        <div className="h-1.5 rounded-full bg-gradient-to-r from-[#e6ccff]/70 via-white/60 to-white/40 relative overflow-hidden">
          <div className="absolute left-0 top-0 h-full w-[80%] bg-[#B547EB] rounded-full" />
        </div>
      </div>
      ...
      <div className="w-full mt-2 space-y-6">
        <div className={`${wide} mx-auto mt-6`}>
          <div className="flex items-start gap-3">
            ...
            />
            <SpeechBubble>
              <p className="text-sm font-semibold text-gray-800">今や将来の生活のための備えができているブヒか？</p>
            </SpeechBubble>
          </div>
        </div>

        <div className={`${wide} mx-auto space-y-3`}>
          {PREPARATION_OPTIONS.map((option, index) => {
            ...
            return (
              ...
              >
                <Image
                  src={PREPARATION_IMAGES[index] || "/placeholder.svg"}
                  alt={`準備レベル${index + 1}`}
                  width={40}
                  height={40}
                  className="shrink-0"
